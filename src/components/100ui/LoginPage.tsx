...
const LoginPage = ({className}: LoginPageProps) => {
  return (
    <Grid rowGap>
      <div className="relative z-10 col-span-full scale-105 border border-slate-100 bg-white px-8 py-10  text-left shadow-xl md:p-24 md:pb-40 lg:col-span-6">
        ...
        <div className="mb-6 flex w-full justify-between">
          ...
          <button className="cursor-pointer  text-xs">Forgot password?</button>
        </div>

        <div className="flex gap-4">
          <button className="cursor-pointer whitespace-nowrap rounded bg-black px-8 py-2 text-white">
            Log in
          </button>
          <button className="cursor-pointer whitespace-nowrap rounded border border-slate-400 px-8 py-2 text-black">
            Sign up
          </button>
        </div>
      </div>
      ...
      <div
        className="relative col-span-full h-full min-h-screen bg-slate-200 bg-cover p-6 lg:col-span-6 lg:-ml-6 lg:p-10"
        style={{
          background:
